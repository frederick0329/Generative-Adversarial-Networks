    ...
    def train(self, epochs=1):
        for i in range(epochs):
            ...
            for j in range(self.dataset.train_batch_count):
                ...
                d_loss_real = self.criterion(outputs, self.real_labels)
                ...
                d_loss_fake = self.criterion(outputs, self.fake_labels).cuda()
                ...
                g_loss = 0.5 * self.criterion(outputs, self.real_labels)    
...
if __name__ == "__main__":
    trainer = Trainer(exp_name='lsgan')
