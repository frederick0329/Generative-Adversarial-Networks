...
class Trainer():
    ...
    def build_graph(self):
        ...
        with self.graph.as_default():
            ...
            self.d_clip = [v.assign(tf.clip_by_value(v, -0.01, 0.01)) for v in train_vars]
                ...
                for i in range(epochs):
                    ...
                    for j in range(self.dataset.train_batch_count):
                        ...
                        for k in range(self.d_steps):
                            ...
                            real_scores, fake_scores, d_loss,  _, _ = sess.run([self.real_scores, self.fake_scores, self.d_loss, self.d_optim, self.d_clip], 
